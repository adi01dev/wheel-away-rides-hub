...
const BecomeHost = () => {
  return (
    <section className="py-16 bg-wheelteal-700 text-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex items-center">
                ...
                <span>Free listing and setting your own availability</span>
              </li>
              <li className="flex items-center">
                <svg className="h-5 w-5 mr-2 text-wheelteal-200" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-lg shadow-lg max-w-[250px]">
